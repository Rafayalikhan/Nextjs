...
const ProfileDropdown = () => {
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      await axios.post('https://br-backend-server.vercel.app/api/user/logout-user');
  ...
  return (
    <Dropdown as="li" className="nav-item ms-2" drop="down" align="end">
      <DropdownToggle className="nav-link btn icon-md p-0 content-none" role="button">
        <Image className="avatar-img rounded-2" src={avatar7} alt="avatar" />
      </DropdownToggle>
      <DropdownMenu className="dropdown-animation dropdown-menu-end pt-3 small me-md-n3">
        <li className="px-3">
          <div className="d-flex align-items-center position-relative">
            ...
            <div>
              <Link className="h6 stretched-link" href="/profile/feed">
                Lori Ferguson
              </Link>
        ...
        <li>
          {/* Updated Sign Out to trigger handleLogout */}
          <button className="dropdown-item bg-danger-soft-hover" onClick={handleLogout} disabled={loading}>
